...
{
    public class MakeYourOwnController : Controller
    {
        private readonly ApplicationContext _context;

        public MakeYourOwnController(ApplicationContext context)
        {
            _context = context;
        }
        ...
        // GET: MakeYourOwn/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: MakeYourOwn/Create
